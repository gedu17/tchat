...
//Returns the div id
string my_friend::add_to_chatlog(string msg, string user, bool write_to_db, time_t time_now) {
    random_device rd;
    mt19937_64 gen(rd());
...
string my_friend::add_to_chatlog(string msg) {
    random_device rd;
    mt19937_64 gen(rd());
    uniform_int_distribution<uint8_t> numb(0,61);
    auto get_symbol = [](uint8_t number) -> char {
...
string my_friend::add_to_chatlog_range(bool write_to_db, time_t time_from, time_t time_until) {
    random_device rd;
    mt19937_64 gen(rd());
    uniform_int_distribution<uint8_t> numb(0,61);
    auto get_symbol = [](uint8_t number) -> char {
