...
public:
    ...
    string add_to_chatlog(string msg, string user, bool write_to_db, time_t time_now = time(nullptr));
    string add_to_chatlog(string msg);
    string add_to_chatlog_range(bool write_to_db, time_t time_from, time_t time_until);
